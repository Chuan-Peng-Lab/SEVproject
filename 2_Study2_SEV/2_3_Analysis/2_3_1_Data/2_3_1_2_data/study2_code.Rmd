...
## words list based on average ratings (marked with valence)
```{r words list based on average ratings}
...
## 2.Count-based categorization
```{r Count-based categorization}
...
tmp3Mor$word<-factor(
  tmp3Mor$word,
  levels = c("狼心狗肺","无恶不作","善良","伤风败俗","孝顺","黑心","大逆不道", "忘恩负义","丧尽天良","不孝","缺德"),
...
### Words list based on count
```{r Words list based on count}
...
### Radar chart and violin chart
corresponds to Fig.6 in the article
```{r Radar chart and violin chart,warning=FALSE}
